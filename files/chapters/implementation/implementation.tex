...
\lstinputlisting[caption=one of EventCreator methods responsible for emitting \emph{QUERY\_FOR\_STUDENT} action, label=lst:emmitingaction]{listings/emmitingaction.js}
