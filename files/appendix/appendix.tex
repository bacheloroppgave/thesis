...
\lstinputlisting[caption=SQL code for initial database tables and relations, label=lst:databasesql]{listings/database.sql}
\newpage
%\begin{landscape}
%\begin{figure}[h]
\begin{sidewaysfigure}
  \centering
  \scalebox{0.6}[0.6]{\scalefont{1.4}{\input{graphs/databaseer.tex}}}
